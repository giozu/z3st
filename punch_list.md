...
<a id="code-p0-4"></a>
- [ ] **CODE-P0-4** — `z3st/__main__.py:157` imports `from core.mesh.plotter import MeshPlotter`; should be `from z3st.core.mesh.plotter import MeshPlotter`. `--mesh_plot` crashes with `ImportError`.
