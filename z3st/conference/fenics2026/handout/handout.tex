...
\begin{minipage}[t]{0.56\linewidth}
  ...
  \begin{itemize}[leftmargin=4mm,itemsep=1pt,topsep=2pt]
    ...
    \item materials and cases are YAML; verified by $\sim$50 CI non-regression checks
  \end{itemize}
...
\begin{minipage}[t]{0.40\linewidth}
  \centering
  \fbox{\includegraphics[width=\linewidth]{../oral/figures/case14_damage.png}}\\[1.5mm]
  ...
  plane-strain reproducer of McClenny et al. (JNM 2022).}
\end{minipage}
...
\begin{center}\footnotesize\color{z3ink!75}
  Giovanni Zullo $\cdot$ Politecnico di Milano $\cdot$ giovanni.zullo@polimi.it
