  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.44\textwidth}
      ...
      \begin{tikzpicture}[font=\scriptsize, node distance=6mm,
        ...
        \draw[-{Stealth}] (t) -- node[left=1pt]{\tiny $\alpha_u$} (m);
        \draw[-{Stealth}] (m) -- node[left=1pt]{\tiny $\alpha_D$} (d);
        \draw[-{Stealth}, z3grey] (d.east) to[bend left=60] (t.east);
      \end{tikzpicture}\\[3pt]
  ...
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \item contact pressure \alert{emerges} (penalty, \alert{AD} tangent) and
  ...
  \begin{columns}[T]
    \begin{column}{0.58\textwidth}
      ...
      \begin{itemize}
        ...
        \item \alert{live demo} -- a coupled case end to end at the poster session
      \end{itemize}
    \end{column}
    \begin{column}{0.42\textwidth}
      \textbf{Future developments}
      \begin{itemize}
        \item \texttt{dolfinx\_mpc} for contact -- multi-point constraints give
              per-facet contact pressure (axial ridging) and periodic BCs
        \item coupling to fuel codes: \alert{SCIANTIX} (fission-gas behaviour) and
              \alert{M\'erope} (microstructure)
...
\begin{frame}{Backup: hero case verified against McClenny (2022)}
  ...
  {\scriptsize radial $T$ profile, $T$ history, damage penetration -- cf.\ McClenny (2022), \textit{J.\ Nucl.\ Mater.} 565, Fig.\ 7b}\\[3pt]
