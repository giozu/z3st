// --.. ..- .-.. .-.. --- --.. ..- .-.. .-.. --- --.. ..- .-.. .-.. ---
//
//  Gmsh GEO for a 3D annular cylinder, radial-structured mesh
//
...
Ri = 0.004;  // Inner radius (m)
Ro = 0.040;  // Outer radius (m)
Lz = 0.100;  // Height (m)

num_points_radial = 21;      // Number of points in the radial direction
num_points_circ_qtr = 16;    // Number of points on each 90-degree arc
num_layers_height = 28;      // Number of element layers along the height
...
Physical Surface("inner") = {out[2], out[8], out[14], out[20]};
Physical Surface("outer") = {out[4], out[10], out[16], out[22]};
Physical Volume("volume")        = {out[1],  out[7],  out[13], out[19]};
