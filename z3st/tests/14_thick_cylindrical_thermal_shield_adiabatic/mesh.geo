...
num_points_radial = 30;      // Number of points in the radial direction
num_points_circ_qtr = 20;    // Number of points on each 90-degree arc
num_layers_height = 20;      // Number of element layers along the height
