...
Loading boundary conditions from 'boundary_conditions.yaml'
  **[INFO]** Neumann thermal BC on 'steel' → 4810.0 W/m² at region 'xmin'
  **[INFO]** Dirichlet thermal BC on 'steel' → 583.0 K (first step) at region 'xmax'
...
**[INFO]** Assembling thermal problem...
  ...
  Applying flux on subdomain id = 5
  Linear solver
  T_new: min=572.82 K, max=583.00 K, mean=578.00 K
  ||ΔT||/||T|| = 4.555e-01
...
Simulation completed in 32.04 s
