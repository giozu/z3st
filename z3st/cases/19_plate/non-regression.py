...
plot_field_along_x(
    x, y, z, field=ux, field_name="Displacement ux (m)", case_dir=CASE_DIR,
    y_target=y_target, z_target=z_target, color="tab:green"
)
plot_field_along_x(
    x, y, z, field=sigma_vm, field_name=r"Von Mises stress (Pa)", case_dir=CASE_DIR,
    y_target=y_target, z_target=z_target, color="tab:orange"
)
