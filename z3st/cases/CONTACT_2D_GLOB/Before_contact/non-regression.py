...
Lx_ext = float(geom.get("Lx_ext", 0.03))
Ly_ext = float(geom.get("Ly_ext", 0.50))
Lx_int = float(geom.get("Lx_int", 0.028))
Ly_int = float(geom.get("Ly_int", 0.499))
Lx_mid = float(geom.get("Lx_mid", 0.025))
Ly_mid = float(geom.get("Ly_mid", 0.45))
