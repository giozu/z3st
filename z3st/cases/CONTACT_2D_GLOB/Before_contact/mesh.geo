...
Lx_int = 0.028;  // Longueur intérieure (m)
Ly_int = 0.499;  // Largeur intérieure (m)
Lx_mid = 0.025; // Longueur du rectangle central (m)
Ly_mid = 0.45; // Largeur du rectangle central (m)
