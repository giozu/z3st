...
**[INFO]** Assembling thermal problem...
  ...
  → q_third[steel](W/m3) min = 1.35e+02, max = 2.00e+06, mean = 2.36e+05
  Linear solver
  T_new: min=490.00 K, max=562.77 K, mean=554.21 K
  ||ΔT||/||T|| = 4.339e-01
...
Simulation completed in 10.57 s
