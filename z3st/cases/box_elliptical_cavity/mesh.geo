...
ax  = 0.1072;      // ellipse semi-axis X (m)
ay  = 0.1072;      // ellipse semi-axis Y (m)
az  = 0.05;        // ellipse semi-axis Y (m)

h_box = 0.0400;    // target element size (m)
h_sph = 0.0015;    // target element size (m)
...
Field[1].NumPointsPerCurve = 150;       // accuracy of distance computation
...
Field[2].DistMax = Lx / 2;              // beyond this distance → SizeMax
