...
"""
Z3ST case: 6_thick_cylindrical_shell_non_adiabatic_2D

non-regression script
---------------------
Steady-state axisymmetric cylindrical wall (Dirichlet-Dirichlet).
...
# Temperature
ax2 = ax1.twinx()
ax2.plot(r_T, T, "ks", label="Num. Temperature (Cyl.)", markersize=3, alpha=0.4)
ax2.plot(r_T, T_ref, "k--", label="Ana. Temperature (Slab)", linewidth=1.0, alpha=0.8)
