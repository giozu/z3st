...
// --- Parameters ---
Ri = 2.40; // Inner radius (m)
Ro = 2.50; // Outer radius (m)
Lz = 15.0; // Height (m)
...
num_layers_height = 15;      // Number of element layers along the height
...
// --- 2D Structured Mesh Commands ---
// Apply transfinite constraints to lines for structured meshing
// Radial lines:
