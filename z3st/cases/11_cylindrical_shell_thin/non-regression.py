...
"""
Z3ST case: 11_cylindrical_shell_thin
...
plotter_sigma_cylinder(
    ...
    sigma_zz_ana_L=sigma_zz_ana_M,
    sigma_rr_ana_L=sigma_rr_ana_M,
)
...
plotter_strain_cylinder(
    ...
    strain_rr_ana_L=strain_rr_ana_M,
    strain_zz_ana_L=strain_zz_ana_M,
)
