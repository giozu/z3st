...
Ly = 0.050;  // cross-section width (m)
Lz = 0.050;  // cross-section height (m)

nx = 11;     // nodes along x -> (nx-1) elements
ny = 3;      // nodes along y -> (ny-1) elements
nz = 3;      // nodes along z -> (nz-1) elements
...
// --- Transfinite structure for hex mesh ---
...
// Physical groups
// Labels follow declaration order (1-7), match geometry.yaml.
