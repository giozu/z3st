...
Ri = 1.000;  // Inner radius (m)
Ro = 1.110;  // Outer radius (m)
Lz = 10.00;  // Height

num_points_radial = 15;      // Number of points in the radial direction
num_points_circ_qtr = 10;    // Number of points on each 90-degree arc
num_layers_height = 10;      // Number of element layers along the height
...
// 2D Structured Mesh
Transfinite Line {9, 10, 11, 12} = num_points_radial Using Progression 1.08;
