...
ax1.plot(r_s_s, s_rr_ana * Pa_to_MPa, "-", color="#D55E00", lw=1.5, label=r"Ana. $\sigma_{rr}$")
ax1.plot(r_s_s, s_tt_ana * Pa_to_MPa, "-", color="#009E73", lw=1.5, label=r"Ana. $\sigma_{\theta\theta}$")
ax1.plot(r_s_s, s_zz_ana * Pa_to_MPa, "-", color="#0072B2", lw=1.5, label=r"Ana. $\sigma_{zz}$")
