...
- The material card declares `sigma_c: 1.0e+9 Pa` directly; `Gc` is auto-derived in `spine.py:147-149` (AT1: `Gc = (8/3)·lc·σc²/E ≈ 93 J/m²` at `lc = 5e-5 m`). The AT1 threshold is `ψc = 3·Gc/(16·lc) ≈ 0.35 MJ/m³`, comfortably below the cold-rim tensile-hoop-stress driving energy (~1 MJ/m³ scale) so damage initiates and propagates along the contact arc.
